    ...
    <section id="mainCreateProject">
        ...
        <!-- start upload project -->
            ...
            <div id="nameFileCreateProject" class="col">
                <p id="nameProjectCP" class="col-69">Navn på prosjekt:</p>
            ...
            <div id="addStudents" class="col">
                <p id="addStudentCP" class="col-69">Legg til andre studenter:</p>
                <input id="addStudentCPTxt" class="col-96" type="text" name="Add Students" <?php echo $chooseStudent; ?>>
            </div>

            <div class="clearfix"></div>

            <div id="addTeacher" class="col">
                <p id="addTeacherCP" class="col-69">Legg til lærer:</p>
                <input id="addTeacherCPTxt" class="col-96" type="text" name="Add Teacher" <?php echo $chooseTeacher; ?>>
            </div>
            <div class="clearfix"></div>


            <div id="studyTopic" class="col">
                <p id="studyTopicCP" class="col-69">Emne:</p>
                <input id="studyTopicCPTxt" class="col-96" type="text" name="Choose Study Topic" <?php echo $chooseTopic; ?>>
            </div>
            <div class="clearfix"></div>
